    ...
    public function up(): void
    {
        if (! Schema::hasTable('payment_per_diem_employees')) {
            Schema::create('payment_per_diem_employees', function (Blueprint $table) {
                ...
                $table->decimal('breakfast_deduction', 18, 2)->default(0);
                $table->decimal('lunch_deduction', 18, 2)->default(0);
                $table->decimal('dinner_deduction', 18, 2)->default(0);
                $table->decimal('accommodation_deduction', 18, 2)->default(0);
                $table->decimal('transport_cost', 18, 2)->default(0);
                $table->decimal('fuel_cost', 18, 2)->default(0);
                $table->decimal('other_cost', 18, 2)->default(0);
                $table->decimal('daily_rate', 18, 2)->default(0);
                $table->decimal('calculated_per_diem', 18, 2)->default(0);
